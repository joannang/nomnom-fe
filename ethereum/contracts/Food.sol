...
contract Food is ERC721URIStorage, ERC721Enumerable {
    ...
    function buy(address owner, string memory foodName) public returns (uint256) {
        uint256 tokenID = tokenIDTracker.current();
        tokenIDTracker.increment();
        _mint(owner, tokenID);
        _setTokenURI(tokenID, foodName);
        return tokenID;
    }
