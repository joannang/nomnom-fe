...
const LoginPage: React.FC = () => {
        ...
        // if (username && password) {
            ...
            try {
                if (type == 'user') {
                    ...
                    // await appStore.supplierSignIn(username, password);
    ...
    const UserCard = () => (
        <Card className={styles.card}>
            ...
            <div>
                <a onClick={() => uiState.setSignUpModalOpen(true)}>
    ...
    const SupplierCard = () => (
        ...
        <Button
            ...
            type="primary"
            className={styles.button}
            onClick={(e) => handleLogin(e, 'supplier')}
        >
            Login
        </Button>
        <div>
            <a onClick={() => uiState.setSupplierSignUpModalOpen(true)}>
                Are you a new supplier? Click here to sign up.
            </a>
        </div>
    </Card>
    )
                ...
                <Row justify="center">
                    ...
                    <Col xs={24} lg={14} className={styles.col}>
                        <div className={styles.container}>
                            ...
                            <Tabs defaultActiveKey="1" centered onChange={handleChangeTabs}>
                                <TabPane tab="Sign In as User" key="1">
                                    <UserCard />
                                </TabPane>
                                <TabPane
                                    tab="Sign In as Supplier"
                                    key="2"
                                >
                                    <SupplierCard/>
                                </TabPane>
